...
//    delete(test1);
//    if(test3.getChildren()[0]->getNode() == 3){
...
//    if(testAssignment.getChildren()[0]->getNode()  == 3)
...
//    if(testMove2.getChildren()[0]->getNode() == 5 && testMove1.getChildren().size() == 0)
...
//    if(testMove2.getChildren()[0]->getNode() == 5 )
